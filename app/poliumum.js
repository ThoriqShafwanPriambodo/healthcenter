...
function load_poliumum() {
    $.post(
        "poliumum/load_poliumum",
        {},
        function (data) {
            console.log(data);
                ...
                function (data) {
                    if (data.status === "success") {
                        Swal.fire({
                            ...
                            load_poliumum(); // Memuat data setelah update
                            load_patient();
                            load_poli();
                        });
                    } else {
...
$(document).ready(function () {
    ...
    $(".tittle").html("Poliklinik Umum - HealthCenter");
    $(".page-title").html("Poliklinik Umum");
