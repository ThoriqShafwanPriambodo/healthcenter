...
function load_poligigi() {
    $.post(
        "poligigi/load_poligigi",
        {},
        function (data) {
            console.log(data);
            ...
            $("#table > tbody").html("");
            $.each(data.poligigi, function (idx, val) {
                html = "<tr>";
                html += "<td>" + (idx + 1) + "</td>";
...
function load_patient() {
    $.post("poligigi/load_patient", function (res) {
...
let txpoliChoices;
function load_poli() {
    $.post("poligigi/load_poli", function (res) {
                ...
                function (data) {
                    if (data.status === "success") {
                        Swal.fire({
                            ...
                            load_poligigi(); // Memuat data setelah update
                            load_patient();
                            load_poli();
                        });
                    } else {
...
$(document).ready(function () {
    ...
    $(".tittle").html("Poliklinik Gigi - HealthCenter");
    $(".page-title").html("Poliklinik Gigi");
